...
class Options():
    ...
    def initialize(self):
        self.parser.add_argument('--datarootA', required=True, help='path to image A', default='./images/original_A.png')
        self.parser.add_argument('--datarootB', required=True, help='path to image A', default='./images/original_B.png')
        ...
        self.parser.add_argument('--fast', action='store_true', default = True, help='if specified, stop the algorithm in layer 2, to accelerate runtime.')
        ...
        self.parser.add_argument('--lambda_T', type=float, default=0.1, help='optimal transport threshold')
